...
public final class ViewControllerUtilities : NSObject {
    ...
    @objc(setUpDefaultBChatStyleForVC:withTitle:customBackButton:)
    public static func setUpDefaultBChatStyle(for vc: UIViewController, title: String?, hasCustomBackButton: Bool) {
