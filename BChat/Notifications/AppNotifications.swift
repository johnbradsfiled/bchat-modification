...
struct AppNotificationUserInfoKey {
    ...
    static let threadNotificationCounter = "BChat.AppNotificationsUserInfoKey.threadNotificationCounter"
}
    ...
    public func notifyUser(for incomingMessage: TSIncomingMessage, in thread: TSThread, transaction: YapDatabaseReadTransaction) {
        ...
        switch previewType {
            case .noNameNoPreview:
                notificationTitle = "BChat"
                
            case .nameNoPreview, .namePreview:
                switch thread {
                    case is TSContactThread:
                        notificationTitle = (isMessageRequest ? "BChat" : senderName)
