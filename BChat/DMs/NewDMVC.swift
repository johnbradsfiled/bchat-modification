...
final class NewDMVC : BaseVC, UIPageViewControllerDataSource, UIPageViewControllerDelegate, OWSQRScannerDelegate {
    ...
    private lazy var tabBar: TabBar = {
        let tabs = [
            TabBar.Tab(title: NSLocalizedString("vc_create_private_chat_enter_bchat_id_tab_title", comment: "")) { [weak self] in
...
private final class EnterPublicKeyVC : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let userPublicKeyContainer = UIView(wrapping: userPublicKeyLabel, withInsets: .zero, shouldAdaptForIPadWithWidth: Values.iPadUserBChatIdContainerWidth)
        // Explanation label
