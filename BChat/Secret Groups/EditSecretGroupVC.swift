...
@objc(SNEditSecretGroupVC)
final class EditSecretGroupVC : BaseVC, UITableViewDataSource, UITableViewDelegate,UITextFieldDelegate {
    ...
    private func setUpViewHierarchy() {
        ...
        groupNameContainer.set(.width, to: 200)
    ...
    private func commitChanges() {
        let popToConversationVC: (EditSecretGroupVC) -> Void = { editVC in
