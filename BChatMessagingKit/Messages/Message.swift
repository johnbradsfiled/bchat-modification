...
public extension Message {
    ...
    static func requiresExistingConversation(message: Message, threadVariant: BChatThread.Variant) -> Bool {
    ...
    static func processRawReceivedReactions(
        ...
        let blinded15UserPublicKey: String? = BChatThread
        ...
        let blinded25UserPublicKey: String? = BChatThread
            .getUserHexEncodedBlindedKey(
                db,
                threadId: openGroupId,
                threadVariant: .community,
