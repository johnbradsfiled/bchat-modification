...
public extension Profile {
    ...
    static func displayName(_ db: Database? = nil, id: ID, threadVariant: BChatThread.Variant = .contact, customFallback: String? = nil) -> String {
    ...
    static func displayNameNoFallback(_ db: Database? = nil, id: ID, threadVariant: BChatThread.Variant = .contact) -> String? {
        guard let db: Database = db else {
...
public extension Profile {
    ...
    static func truncated(id: String, threadVariant: BChatThread.Variant) -> String {
    ...
    func displayName(for threadVariant: BChatThread.Variant = .contact) -> String {
        return Profile.displayName(for: threadVariant, id: id, name: name, nickname: nickname)
    }
    
    static func displayName(
        for threadVariant: BChatThread.Variant,
        id: String,
        name: String?,
        nickname: String?,
