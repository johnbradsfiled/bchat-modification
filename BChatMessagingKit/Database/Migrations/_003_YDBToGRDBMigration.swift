...
enum _003_YDBToGRDBMigration: Migration {
    ...
    static func migrate(_ db: Database) throws {
        ...
        try legacyThreads.sorted(by: { lhs, rhs in lhs.uniqueId < rhs.uniqueId }).forEach { legacyThread in
            ...
            let threadVariant: BChatThread.Variant
    ...
    private static func mapLegacyTypesForNSKeyedUnarchiver() {
        ...
        NSKeyedUnarchiver.setClass(
            SMKLegacy._DBLinkPreview.self,
            forClassName: "BChatMessagingKit.OWSLinkPreview"
        )
        NSKeyedUnarchiver.setClass(
        ...
        NSKeyedUnarchiver.setClass(
            ...
            forClassName: "BChatMessagingKit.NotifyPNServerJob"
        )
        NSKeyedUnarchiver.setClass(
        ...
        NSKeyedUnarchiver.setClass(
            ...
            forClassName: "BChatMessagingKit.SNMessageSendJob"
        )
        NSKeyedUnarchiver.setClass(
            SMKLegacy._MessageReceiveJob.self,
            forClassName: "BChatMessagingKit.MessageReceiveJob"
        )
        NSKeyedUnarchiver.setClass(
            SMKLegacy._AttachmentUploadJob.self,
            forClassName: "BChatMessagingKit.AttachmentUploadJob"
        )
        NSKeyedUnarchiver.setClass(
            SMKLegacy._AttachmentDownloadJob.self,
            forClassName: "BChatMessagingKit.AttachmentDownloadJob"
        )
        NSKeyedUnarchiver.setClass(
        ...
        NSKeyedUnarchiver.setClass(
            ...
            forClassName: "BChatMessagingKit.ClosedGroupControlMessage"
        )
        NSKeyedUnarchiver.setClass(
        ...
        NSKeyedUnarchiver.setClass(
            ...
            forClassName: "BChatMessagingKit.DataExtractionNotification"
        )
        NSKeyedUnarchiver.setClass(
